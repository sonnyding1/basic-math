...
import { divisionWeight, assignDivisionProblem } from '@/lib/problems';
...
export default function DivisionPage() {
  ...
  useEffect(() => {
    ...
    const { problemString, problemAnswer } = assignDivisionProblem(includeNegative, includeTwoDigit);
            ...
            onClick={(e) => {
              if (!isAttempted) {
                ...
                if (parseInt(userAnswer) === answer && !isCorrect) {
                  ...
                  incrementXP(divisionWeight(includeNegative, includeTwoDigit));
                }
                setIsAttempted(true);
              } else {
                // state 2: attempted
