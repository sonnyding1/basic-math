...
import { multiplicationWeight, assignMultiplicationProblem } from '@/lib/problems';
...
export default function MultiplicationPage() {
  ...
  useEffect(() => {
    ...
    const { problemString, problemAnswer } = assignMultiplicationProblem(includeNegative, includeTwoDigit);
            ...
            onClick={(e) => {
              if (!isAttempted) {
                ...
                if (parseInt(userAnswer) === answer && !isCorrect) {
                  ...
                  incrementXP(multiplicationWeight(includeNegative, includeTwoDigit));
                }
                setIsAttempted(true);
              } else {
                // state 2: attempted
